...
[Подготовьте среду](https://gitverse.containers.cloud.ru/prerequisites/){target=_blank}, если пропустили этот шаг в начале. 
...
### 5. Авторизация в реестре Artifact Registry 
